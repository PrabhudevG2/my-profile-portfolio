    ...
    <footer className="py-10 bg-resume-dark text-white">
      <div className="container px-4 md:px-6">
            ...
            <div className="flex flex-col md:items-end">
              <div className="space-y-2">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-resume-muted hover:text-white transition-colors" aria-label="LinkedIn">
                    <svg 
                  ...
                  <a href="#" className="text-resume-muted hover:text-white transition-colors" aria-label="GitHub">
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      width="20" 
                      height="20" 
                  ...
                  <a href="#" className="text-resume-muted hover:text-white transition-colors" aria-label="Email">
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      width="20" 
                      height="20" 
        ...
        <div className="mt-8 pt-6 border-t border-resume-muted/20 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-resume-muted">© {currentYear} All Rights Reserved</p>
          <p className="text-sm text-resume-muted mt-2 md:mt-0">
            Made with <span className="text-resume-accent">♥</span> for excellence
          </p>
        </div>
      </div>
    </footer>
